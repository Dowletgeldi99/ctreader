...
## Strategy V4.1 Wave Rider на cBot Cloud
...
Направление волны задают EMA 8/21 на M15, а directional efficiency последних
12 M5 отсекает боковик. Вход создаёт пробой шести закрытых M5 с проверкой тела,
тени, диапазона и tick volume.
Сначала открывается Probe 0.01 lot, после подтверждения — Main 0.01 lot.
Структурный SL ограничен диапазоном 1.3–2.5 M5 ATR, TP равен 2.5R. Дневного лимита
