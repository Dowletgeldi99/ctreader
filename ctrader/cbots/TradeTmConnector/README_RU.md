...
## Strategy V4.2 Wave Rider на cBot Cloud
...
Направление волны задаёт взаимное положение EMA 8/21 на M15. Вход создаёт пробой
шести закрытых M5: тело должно занимать не менее 35%, диапазон — 0.3–3 ATR.
Directional efficiency, тени, глубина закрытия и tick volume сохраняются для
анализа, но не блокируют исполнение.
Сначала открывается Probe 0.01 lot, после подтверждения — Main 0.01 lot.
